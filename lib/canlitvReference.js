...
export function getCanliTvModeLabel(mode) {
  const labels = {
    telif_redirect: "Resmi Site",
    embedded_youtube: "YouTube",
    embedded_iframe_url: "Gömülü Yayın",
    embedded_player_src: "Oynatıcı",
    iframe_src_inline: "Gömülü Yayın",
    unknown: "Bilinmiyor",
    fetch_error: "Ulaşılamadı",
  };
